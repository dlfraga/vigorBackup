...
public class Vigor3220 extends BaseDownloader{
	/**
	 * The connection.
	 */
	 ...
	 */
	private static final String FILE_DOWNLOAD_STRING = "/V3220_temp.cfg";
	...
	/**
	 * Concrete class that implements the downloading of the Vigor3220 firmware
	 * files.
	 * 
	 * @param routr The router information.
	 */
	public Vigor3220(Router routr) {
		super(routr);
	}
